...
torchrun --standalone --nproc_per_node=2 train.py \
  ...
  --train_split train/cvrp200_test_10000_norm_solved_k26.npz \
  --validation_split val/cvrp200_val_500_norm_solved_k26.npz \
  --test_split test/cvrp200_train_3000_norm_solved_k26.npz \
  --num_vehicles 26 \
  --batch_size 16 \
  --num_epochs 50 \
  --hidden_dim 192 \
